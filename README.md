...
총 2748개의 preprocessed data를 사용해 LoRA finetuning을 진행하였습니다.<br>
<img src='./assets/lora finetuning.jpg' width=500><br>
🚨 해당 단계에서, 원하는 스타일이 적용되긴 했지만, 원본 이미지 속 인물과 표정과 자세가 일치하지 않는다는 문제점 발견을 발견했습니다.<br><br>


### 3. 원본 이미지에 충실하기 (ControlNet w/ Canny Edge)<br>
2에서 생긴 문제점을 해결하기 위해서 입력 이미지의  edge 정보를 활용하기로 결정하여 <br>
Controlnet w/ canny edge를 활용하여 입력 이미지의 edge 정보를 반영하여 생성했습니다.<br>
